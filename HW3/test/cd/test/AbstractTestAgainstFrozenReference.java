...
abstract public class AbstractTestAgainstFrozenReference {
	...
	private void runReference() throws IOException, InterruptedException {
        ...
        String javaExe = System.getProperty("java.home")+fileSep+"bin"+fileSep+Config.JAVA_EXE;
        
        ProcessBuilder pb = new ProcessBuilder(
        	javaExe,
        	"-cp", "lib/frozenReference.jar:lib/junit-4.12.jar:lib/antlr-4.4-complete.jar",
	...
	private List<ClassDecl> testParser() throws Exception {
...

		{
			...
			if (parserOut.equals(PARSE_FAILURE)
				|| parserRef.equals(PARSE_FAILURE))
